...
public class TestJavaCollections {
    ...
    private static final int N = 100000;          // Số phần tử để test chèn (insertion)
    ...
    private static void compareQueues() {
        ...
        long end = System.nanoTime();
        long priorityQueueInsert = end - start;
        ...
        long linkedListQueueInsert = end - start;

        // -----------------------------
        // 2) Test dequeue (poll) N lần
        // -----------------------------
        start = System.nanoTime();
        for (int i = 0; i < N; i++) {
            priorityQueue.poll();
        ...
        long priorityQueueDequeue = end - start;
        ...
        long linkedListQueueDequeue = end - start;
        ...
        long priorityQueueIter = end - start;

        start = System.nanoTime();
        for (Integer val : linkedListQueue) {
        }
        end = System.nanoTime();
        long linkedListQueueIter = end - start;

        // -----------------------------
        // In kết quả
        // -----------------------------
        System.out.println("[Insertion]      PriorityQueue: " + priorityQueueInsert + " ns, "
                + "LinkedList Queue: " + linkedListQueueInsert + " ns");
        System.out.println("[Dequeue]        PriorityQueue: " + priorityQueueDequeue + " ns, "
                + "LinkedList Queue: " + linkedListQueueDequeue + " ns");
        System.out.println("[Iteration]      PriorityQueue: " + priorityQueueIter + " ns, "
                + "LinkedList Queue: " + linkedListQueueIter + " ns");

        System.out.println("\n--- Nhận xét nhanh ---");
        System.out.println("* PriorityQueue: Duy trì thứ tự theo priority, O(log n) cho insert/poll.");
        System.out.println("* LinkedList Queue: Chèn và lấy (poll) O(1), nhưng không duy trì thứ tự ưu tiên.");
    }
}
